...
function checkUserStatus(cookie) {
  ...
  if (cookie && tokenReader(cookie).loggedin) {
    ...
    document.getElementsByClassName("user")[0].innerHTML = '<p>Hi ' + tokenReader(cookie).username + '!</p>';
    // TODO: Add "edit account" link to allow users to change their data

  } else {
    document.getElementsByClassName("user")[0].innerHTML = '<ul><a href="login.html"><li>Log in</li></a><a href="register.html"><li>Register</li></a></ul>';
  }
}
